...
export function SettingsPanel({ settings, canEdit }: { settings: GlobalSettings; canEdit: boolean }) {
  ...
  const mutation = useMutation({
    ...
    onSuccess: async () => queryClient.invalidateQueries({ queryKey: ["settings", "global"] })
  });
